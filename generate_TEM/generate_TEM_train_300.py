...
img_folder='COCO/panoptic_annotation/panoptic_train2017'
...
for file_name in onlyfiles_train:
    ...
    cc=cc+1
    imwrite(os.path.join(output_dir,'COCO_train2014_'+file_annotated[0]+'.tif'),img_sal[::2,::2,:],compress=6)
