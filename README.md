...
We used a data intersection between [COCO](https://cocodataset.org/#home) and [SALICON](http://salicon.net/) to perform our evaluations using the panoptic annotations/segmentations from COCO and the fixations from SALICON. SALICON saves the resulting fixation from a subgroup in train, val, and test of COCO.
